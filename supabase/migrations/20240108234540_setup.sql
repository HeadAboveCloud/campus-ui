...
AS $$
DECLARE
  project_url TEXT := 'https://lxavvlvjtnjdoteebbmd.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx4YXZ2bHZqdG5qZG90ZWViYm1kIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzY4MzE2OSwiZXhwIjoyMDIzMjU5MTY5fQ.MmXUZe2CLWKwH6QqFTRficBbUj1f664bctv0RKFIZwU'; -- full access needed for http request to storage
